/**
 * a slighly modified version of the reverb effect from
...
class SimpleReverb {
  ...
  constructor(context, reverbTime = 1) {
    this.#context = context
    this.input = this.#context.createGain()
    this.#effect = null
    this.#output = this.#context.createGain()
    this.#setup(reverbTime)
...
/*
  Web Audio library
  courtesy of gskinner.com
  https://cdn.jsdelivr.net/gh/mwmwmw/SimpleSound@1.0.0/WebAudio.js
*/

// SAFARI Polyfills
if (!window.AudioBuffer.prototype.copyToChannel) {
  window.AudioBuffer.prototype.copyToChannel = function copyToChannel(
    buffer,
    channel
  ) {
...
if (!window.AudioBuffer.prototype.copyFromChannel) {
  window.AudioBuffer.prototype.copyFromChannel = function copyFromChannel(
    buffer,
    channel
  ) {
