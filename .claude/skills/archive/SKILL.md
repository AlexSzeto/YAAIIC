---
name: archive
description: Archives completed tasks from task.md into docs/feature-history/ and resets task.md for the next feature. USE FOR: after a set of tasks has been completed and you are preparing to start a new feature.
---
