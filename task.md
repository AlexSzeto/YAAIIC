...
- [ ] **Task 1 — Migration script + data model update**
...
- [ ] **Task 2 — Template tag expansion in prompt assembler**
...
- [ ] **Task 3 — Hidden Parts chip UI in PlotSection**
...
- [ ] **Task 4 — Remove OutlinePanel from plot page form**
...
- [ ] **Task 5 — Parts list "(modified)" header postfix**
...
- [ ] **Task 7 — Move Reprompt + Delete to AnyTaleViewer NavRow**
  - In `anytale-form.mjs`:
