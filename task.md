...
- [ ] **Task 1: Create the new state module (`anytale-state.mjs`)**
...
- [ ] **Task 2: Rewrite the prompt assembler for Parts**
...
- [ ] **Task 3: Extend DynamicList to support custom header actions**
...
- [ ] **Task 4: Create the Part item component (`part-item.mjs`)**
...
- [ ] **Task 5: Build category attribute value dropdown logic**
...
- [ ] **Task 6: Build the category attribute's autocomplete input**
...
- [ ] **Task 7: Replace the right panel with TabPanels (Edit/Play)**
...
- [ ] **Task 8: Wire per-part preview generation**
...
- [ ] **Task 9: Clean up removed files and dead references**
