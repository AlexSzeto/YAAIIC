...
- [ ] **Task 1: Create the `anytale` server feature domain**
...
- [ ] **Task 2: Refactor attribute value keys from index-based to name-based**
...
- [ ] **Task 3: Add "Save to Library" and "Delete from Library" buttons in `part-item.mjs`**
...
- [ ] **Task 4: Add Parts Library lookup input in `anytale-form.mjs`**
...
- [ ] **Task 5: Add Reprompt button in `anytale-form.mjs`**
...
- [ ] **Task 6: Add `parts` field to media schema and pass parts data through generation**
