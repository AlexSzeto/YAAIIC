...
- [ ] Task 10: Remove `progressionDisabledParts` from Schema and UI
...
- [ ] Task 11: Replace Add Button with Confirm Icon Button
...
- [ ] Task 12: Fix Action Chip Display to Match Existing Chip Style
...
- [ ] Task 13: Fix Rules Not Applied to Live Preview Prompt
...
- [ ] Task 14: Add Console Tracing to Slot Rule Processing
...
- [ ] Task 15: Restore Per-Part `enabled` Toggle in Parts & Plot Tab
